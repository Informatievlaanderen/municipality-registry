namespace MunicipalityRegistry.Projections.LastChangedList
{
    ...
    public class DataMigrationsContext : RunnerDbContext<DataMigrationsContext>
    {
        ...
        public override Task UpdateProjectionState(string projectionName, long position, CancellationToken cancellationToken)
        {
            throw new InvalidOperationException("Cannot update projection state from this context");
        }

        public override Task UpdateProjectionDesiredState(string projectionName, string desiredState, CancellationToken cancellationToken)
        {
            throw new InvalidOperationException("Cannot update projection state from this context");
        }

        public override Task SetErrorMessage(string projectionName, string? errorMessage, CancellationToken cancellationToken)
        {
    ...
    public class DataMigrationContextMigrationFactory : SqlServerRunnerDbContextMigrationFactory<DataMigrationsContext>
    {
        ...
        protected override DataMigrationsContext CreateContext(DbContextOptions<DataMigrationsContext> migrationContextOptions)
