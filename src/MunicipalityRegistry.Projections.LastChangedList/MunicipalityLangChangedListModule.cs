namespace MunicipalityRegistry.Projections.LastChangedList
{
    ...
    public class MunicipalityLastChangedListModule : LastChangedListModule
    {
        public MunicipalityLastChangedListModule(
        ...
        {
            var logger = loggerFactory.CreateLogger<MunicipalityLastChangedListModule>();
