namespace MunicipalityRegistry.Projections.LastChangedList.Console.Infrastructure.Modules
{
    using System;
    using Autofac;
    ...
    public class LastChangedListConsoleModule : Module
    {
        ...
        private void RegisterProjections(ContainerBuilder builder)
        {
            ...
            builder.Register(c =>
                    new LastChangedListMunicipalityCacheValidator(
                        _configuration.GetConnectionString("LegacyProjections"),
                        "MunicipalityRegistry.Projections.Legacy.MunicipalityDetail.MunicipalityDetailProjections"))
                .AsSelf();
            ...
            builder
                ...
                .RegisterProjections<LastChangedListProjections, LastChangedListContext>(
                    context => new LastChangedListProjections(context.Resolve<LastChangedListMunicipalityCacheValidator>()),
