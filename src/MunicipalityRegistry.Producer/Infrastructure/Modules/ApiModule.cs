        ...
        private void RegisterProjections(ContainerBuilder builder)
        {
            ...
            builder
                ...
                .RegisterProjections<ProducerProjections, ProducerContext>(() =>
                {
                    ...
                    var topic = $"{_configuration[ProducerProjections.MunicipalityTopicKey]}" ?? throw new ArgumentException($"Configuration has no value for {ProducerProjections.MunicipalityTopicKey}");
