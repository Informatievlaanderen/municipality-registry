namespace MunicipalityRegistry.Projector.Caches
{
    using System;
    ...
    public class CachesController : ApiController
    {
        ...
        {
            {"MunicipalityRegistry.Projections.LastChangedList.LastChangedListProjections", LastChangedListProjections.ProjectionName}
        };
